    ...
    public partial class manageroom : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                TextBox1.Text = "TestForRoomName";
                ddlDay.Enabled = false;
                ddlMonth.Enabled = false;
                ddlYear.Enabled = false;
                TextBox2.Enabled = false;
                TextBox2.Text = "This room is about BP2S project";
                ListBox1.Enabled = false;
           
                checkboxinvites.Enabled = false;
                roommanager.Enabled = false;
                roommanager.Text = "Jean-Daniel BIDE (a02313)";


                //ddlDay.Text = "17";
                //ddlMonth.va

                //ddlYear.Items.FindByValue("2018").Selected = true;
                plus.Visible = false;
